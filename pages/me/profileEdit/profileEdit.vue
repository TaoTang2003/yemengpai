<template>
	<list-container>
		...
		<list-item :on-tap="toPersonLabel">
...
<script>
	...
	export default {
		...
		methods: {
			toPersonLabel(){
				uni.navigateTo({
					url:"/pages/me/profileEdit/personLabel/personLabel?title=个性标签",
				})
			},
			toAddress(){
				uni.navigateTo({
					url:"/pages/me/profileEdit/addressEditor/addressEditor?title=地址",
				})
			},
			onAvatarClick() {
				const that = this
